...
/**
 * @title Btntex's BBep20Delegator Contract
 * @notice BTokens which wrap an EIP-20 underlying and delegate to an implementation
 * @author Btntex
 */
contract BBep20Delegator is BTokenInterface, BBep20Interface, ADelegatorInterface {
    /**
   ...
   /**
    ...
    function () external payable {
        require(msg.value == 0,"BBep20Delegator:fallback: cbtntot send value to fallback");
