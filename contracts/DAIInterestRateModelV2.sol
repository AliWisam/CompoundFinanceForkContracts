...
/**
  * @title Btntex's DAIInterestRateModel Contract (version 2)
  * @author Btntex (modified by Dharma Labs)
  * @notice The parameterized model described in section 2.4 of the original Btntex Protocol whitepaper.
